                        ...
                        if btnsalvar is not None:
                            ...
                            if msgerro is None:
                                ...
                                if testalistacondominio is not None:
                                    listacondominios = site.verificarobjetoexiste('CSS_SELECTOR', "[href = '#']",
                                                                                  itemunico=False)
                                                                ...
                                                                if "Indisponível" not in dadosap.text:
                                                                    ...
                                                                    if achoupagina:
                                                                        ...
                                                                        btngerarboleto = site.verificarobjetoexiste(
                                                                            'CSS_SELECTOR',
                                                                            "[class='botao pagarBoleto pagarBoletoParcelado']")
                                                                        if btngerarboleto is not None:
                                                                            ...
                                                                            site.esperadownloads(site.caminhodownload,
                                                                                                 timeout)

                                                                            # Define o nome (baseado no nr do boleto)
                                                                            if numboleto == 0:
                                                                                novonomearquivo = objeto.pastadownload + '\\' + \
                                                                                                  linha[
                                                                                                      identificador] + '.pdf'
                                                                            else:
                                                                                novonomearquivo = objeto.pastadownload + '\\' + \
                                                                            ...
                                                                            arquivobaixado = os.path.join(
                                                                                site.caminhodownload,
                                                                                site.pegaarquivobaixado(
                                                                                    tempoesperadownload))
                                                                            time.sleep(1)
                                                                            ...
                                                                            if os.path.isfile(arquivobaixado):
                                                                                ...
                                                                                listaboletos.append(
                                                                                    aux.adicionarcabecalhopdf(
                                                                                        arquivobaixado, novonomearquivo,
                                                                                        linha[identificador]))
                                                                                numboleto += 1
                                                                                time.sleep(1)
                                                    ...
                                                    if boleto.text == 'Emitir 2ª via':
                                                        ...
                                                        if site.num_abas() > 1:
                                                            ...
                                                            if lembrardepois is not None:
                                                                ...
                                                                # Espera o download finalizar e "pega" o arquivo baixado
                                                                arquivobaixado = os.path.join(site.caminhodownload,
                                                                                              site.pegaarquivobaixado(
                                                                                                  tempoesperadownload))
                                                                time.sleep(1)
                                                                ...
                                                                if os.path.isfile(arquivobaixado):
                                                                    # Renomeia o arquivo baixado para o código de cliente
                                                                    listaboletos.append(
                                                                        aux.adicionarcabecalhopdf(arquivobaixado,
                                                                                                  novonomearquivo,
                                                                                                  linha[identificador]))
                                                                    numboleto += 1
                                                                    time.sleep(1)
                        ...
                        if len(boletos) > 0:
                            for i, boleto in enumerate(boletos, start=1):
                                ...
                                if quantaba > 1:
                                    site.irparaaba(2)
                                    site.delay = 2
                                    textoseguro = site.verificarobjetoexiste('CLASS_NAME', 'bp-campanha-texto')
                                    if textoseguro.text == 'Este seguro não é obrigatório, deseja contratá-lo?':
                                        site.fecharaba(2)
                                    site.delay = delay
                                else:
                                    # Espera o download finalizar
                                    ...
                                    if numboleto == 0:
                                        ...
                                        novonomearquivo = objeto.pastadownload + '\\' + linha[
                                            identificador] + '_' + str(
                                            numboleto) + '.pdf'

                                    # Espera o download finalizar e "pega" o arquivo baixado
                                    arquivobaixado = os.path.join(site.caminhodownload,
                                                                  site.pegaarquivobaixado(tempoesperadownload))
                                    time.sleep(1)

                                    # Verifica se o arquivo baixado de fato existe
                                    if os.path.isfile(arquivobaixado):
                                        # Renomeia o arquivo baixado para o código de cliente
                                        listaboletos.append(aux.adicionarcabecalhopdf(arquivobaixado, novonomearquivo,
                                                                                      linha[identificador]))
                                        numboleto += 1
                                        time.sleep(1)
                                site.irparaaba(1)
                        ...
                        if links is not None:
                            for link in links:
                                ...
                                if numboleto == 0:
                                    ...
                                    novonomearquivo = objeto.pastadownload + '\\' + linha[identificador] + str(
                                        numboleto) + '.pdf'
                                                        ...
                                                        if not site.verificarobjetoexiste('XPATH',
                                                            ...
                                                            if site.verificarobjetoexiste('XPATH',
                                                                ...
                                                                for i, boleto in enumerate(boletos, start=1):
                                                                    ...
                                                                    time.sleep(1)
                                                                    while not baixando:
                                                                        baixando = site.verificarobjetoexiste('XPATH',
                                                                                                              "//span[@class='text-sm font-bold' and text()='Baixando...']",
                                                                                                              sotestar=True) is not None
                                                                    ...
                                                                    site.irparaaba(indice=site.num_abas() - 1)
                                                                    # boletos = site.verificarobjetoexiste('XPATH', "//img[@src='assets/icons/boletos/download.svg']",
                                                                    #                                      buscar_em_iframes=True, itemunico=False)
                            ...
                            if segundonivel is not None:
                                ...
                                if boletos is not None:
                                    for i, boleto in enumerate(boletos, start=1):
                                        ...
                                        if arquivobaixado:
                                            if os.path.isfile(os.path.join(site.caminhodownload, arquivobaixado)):
                                                # Espera o download finalizar e "pega" o arquivo baixado
                                                arquivobaixado = os.path.join(site.caminhodownload, arquivobaixado)
                                            else:
                                                if os.path.isfile(os.path.join(objeto.pastadownload, arquivobaixado)):
                                                    arquivobaixado = os.path.join(objeto.pastadownload, arquivobaixado)
                                        else:
                                            arquivobaixado = site.esperar_novo_download(site.caminhodownload,
                                                                                        arquivos_originais)
        ...
        if site is not None and site.navegador != -1:
            ...
            if botao is not None:
                ...
                if mensagemerro is None:
                    ...
                    if site.verificarobjetoexiste('ID', 'atualizacao-cadastral', sotestar=True):
                        linha[
                            Resposta] = 'Exigindo atualização cadastral, entrar manualmente para realizá-la (necessita de campo que não tem na planilha)'
                    ...
                    if not atualizacaocadastral:
                        ...
                        if botao2via is not None:
                            ...
                            if site.verificarobjetoexiste('CLASS_NAME', 'alert-danger', sotestar=True):
                                ...
                                site.delay = delay
                                objetosboletos = site.verificarobjetoexiste('PARTIAL_LINK_TEXT', 'Recibo No.',
                                                                            itemunico=False)  # Debug
                                for i, boleto in enumerate(objetosboletos, start=1):
                                    objetosboletos[i - 1].click()
                                    time.sleep(1)
                                    ...
                                    if i == 1:
                                        ...
                                        novonomearquivo = os.path.join(objeto.pastadownload,
                                                                       aux.left(linha[identificador], 4) + '_' + str(
                                                                           i) + '.pdf')
                                    arquivos_originais = site.obter_arquivos_atuais(site.caminhodownload)
                                    ...
                                    if linkimpressao is not None:
                                        ...
                                        if os.path.isfile(site.caminhodownload + '\\' + arquivobaixado):
                                            ...
                                            listaboletos.append(
                                                aux.adicionarcabecalhopdf(site.caminhodownload + '\\' + arquivobaixado,
                                                                          novonomearquivo,
                                                                          aux.left(linha[identificador], 4)))
                                            if os.path.isfile(novonomearquivo):
                                                numboleto += 1
                                        ...
                                        if frame is not None:
                                            ...
                                            if botaoimprimir is not None:
                                                ...
                                                if numboleto == 0:
                                                    ...
                                                    novonomearquivo = objeto.pastadownload + '\\' + linha[
                                                        identificador] + '_' + str(numboleto) + '.pdf'
                                ...
                                if boletos:
                                    ...
                                    if boletos is not None:
                                        for i, boleto in enumerate(boletos, start=1):
                                            ...
                                            # Espera o download finalizar e "pega" o arquivo baixado (Espera o download pela página download do chrome)
                                            arquivobaixado = os.path.join(objeto, objeto.pastadownload,
                                                                          site.pegaarquivobaixado(tempoesperadownload))
                    ...
                    if mensagemerro is None:
                        ...
                        if boletos is not None:
                            for i, boleto in enumerate(boletos, start=1):
                                ...
                                # Espera o download finalizar e "pega" o arquivo baixado (Espera o download pela página download do chrome)
                                arquivobaixado = os.path.join(objeto.pastadownload,
                                                              site.pegaarquivobaixado(tempoesperadownload))
                    ...
                    if mensagemerro is None:
                        ...
                        if len(boletos) > 0:
                            for i, boleto in enumerate(boletos, start=1):
                                ...
                                # Espera o download finalizar e "pega" o arquivo baixado (Espera o download pela página download do chrome)
                                arquivobaixado = os.path.join(site.caminhodownload,
                                                              site.pegaarquivobaixado(tempoesperadownload, 1))
        ...
        if len(codigo) > 0:
            ...
            if site is not None and site.navegador != -1:
                ...
                if botao is not None:
                    ...
                    site.delay = delay
                    if erro is None:
                        divs_card_principal = site.verificarobjetoexiste('XPATH',
                                                                         "//*[contains(@class, 'col-12 col-sm-6 col-md-4 box')]",
                                                                         itemunico=False)

                        if divs_card_principal:
                            botoes = site.verificarobjetoexiste('CLASS_NAME', 'bt', itemunico=False)
                            for index, div in enumerate(divs_card_principal):
                                if str(linha[Condominio]).upper() in str(divs_card_principal[index].text).upper():
                                    botoes[index].click()
                                    break
                        ...
                        if botaosegundavia is not None:
                            ...
                            if janelaboleto is not None:
                                ...
                                campoapart = site.verificarobjetoexiste('CLASS_NAME', 'v-select__slot')
                                if campoapart is not None:
                                    campoapart.click()

                                    listacondominios = site.verificarobjetoexiste('CLASS_NAME',
                                                                                  "v-list-item__title",
                                                                                  itemunico=False)
                                    achoucondominio = False
                                    for icondominio in listacondominios:
